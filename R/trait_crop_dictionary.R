#' @name potato_yield
#' @title Trait dictionary for potato yield trial 
#' @docType data
#' @aliases potato_yield
#' @description This data set contains a trait dicionary based on Crop Ontology template for
#' Healthy Tuber and Yield trail in Potato. This trait dictionary is developed at International
#' Potato Center.
...
#' @name potato_lb
#' @title Trait dictionary for potato late blight
#' @docType data
#' @aliases potato_lb
#' @description This data set contains a trait dicionary based on Crop Ontology template for
#' Drought Tolerance Resistant trial in Potato. This trait dictionary is developed at International
